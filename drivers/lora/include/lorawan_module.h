 ...
 * 
 * Copied from lorawan.h
 */

#ifndef ZEPHYR_INCLUDE_LORAWAN_MODULE_H_
#define ZEPHYR_INCLUDE_LORAWAN_MODULE_H_
...
struct mlorawan_join_config {
	union {
		struct mlorawan_join_otaa otaa;
		struct mlorawan_join_abp abp;
	};
	enum mlorawan_class dev_class;
	enum mlorawan_act_type mode;
};

#define LW_RECV_PORT_ANY UINT16_MAX

struct mlorawan_downlink_cb {
 ...
 */
int mlorawan_set_battery_level_callback(uint8_t (*battery_lvl_cb)(void));
 ...
 */
void mlorawan_register_downlink_callback(struct mlorawan_downlink_cb *cb);
 ...
 */
void mlorawan_register_dr_changed_callback(void (*dr_cb)(enum mlorawan_datarate));
 ...
 *                   Must be one of @ref mlorawan_message_type.
 *
 * @return 0 if successful, negative errno code if failure
 */
 ...
 * @return 0 if successful, negative errno code if failure
 */
int mlorawan_set_conf_msg_tries(uint8_t tries);
 ...
 */
void mlorawan_enable_adr(bool enable);
 ...
 * @return 0 if successful, negative errno code if failure
 */
int mlorawan_set_datarate(enum mlorawan_datarate dr);
 ...
 */
enum mlorawan_datarate mlorawan_get_min_datarate(void);
 ...
 */
void mlorawan_get_payload_sizes(uint8_t *max_next_payload_size,
...
#endif /* ZEPHYR_INCLUDE_LORAWAN_MODULE_H_ */
